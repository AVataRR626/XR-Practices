...
public class ObjInteractableGeneral: MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler //, , , IPointerClickHandler
{
    ...
    public ObjInteractableGeneral eventRelay;
    ...
    public void PulseUp()
    {
        ObjScalePulse p = GetComponent<ObjScalePulse>();
